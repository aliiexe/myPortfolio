  ...
  focusAreas: [
    {
      title: "Cybersecurity",
      shortDescription:
        "Web security, secure development, threat-aware architecture, and practical offensive security.",
    },
    {
      title: "Software Engineering",
      shortDescription:
        "Full-stack systems, scalable web apps, performance, and maintainable code.",
    },
    {
      title: "Design",
      shortDescription:
        "Clean interfaces, better user flows, and product-minded visual thinking.",
    },
    {
      title: "Freelance",
      shortDescription:
        "Selected digital work for brands, businesses, and technical products.",
    },
  ],
  about: {
