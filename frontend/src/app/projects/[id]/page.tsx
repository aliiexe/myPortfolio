...
const ProjectDetails = async ({ params }: { params: Promise<{ id: string }> }) => {
  ...
  const projects = [
    ...
    },
    {
      ...
      technologies: [],
      link: "null",
      images: ["/images/projects/opportunai1.png", "/images/projects/opportunai2.png", "/images/projects/opportunai3.png", "/images/projects/opportunai4.png", "/images/projects/opportunai5.png", "/images/projects/opportunai6.png", "/images/projects/opportunai7.png"],
